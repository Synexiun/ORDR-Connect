...
const typeIcon: Record<NotificationType, ComponentType<{ className?: string }>> = {
  hitl: AlertTriangle,
...
const mockNotifications: Notification[] = [
  {
    ...
    type: 'compliance',
    severity: 'critical',
    title: 'HIPAA PHI Exposure Blocked',
    description: 'PHI field detected in agent output — automatically redacted before delivery',
  ...
  },
  {
    ...
    description: '3 customer interactions exceeded 24-hour response SLA',
    timestamp: new Date(Date.now() - 1200000).toISOString(),
    read: false,
    dismissed: false,
    actionRoute: '/interactions',
  },
  {
    id: 'notif-003',
    type: 'escalation',
    ...
    description: 'Collection agent escalated high-value account — requires operator review',
  ...
  },
  {
    ...
    type: 'compliance',
    severity: 'medium',
    title: 'TCPA Quiet Hours Violation',
    description: '3 outbound calls blocked during restricted hours',
  ...
  },
  {
    ...
    description: 'Encryption key approaching 75-day threshold — automated rotation scheduled',
  ...
  },
  {
    ...
    description: 'Collection agent resolution rate dropped below 80% over last 24 hours',
  ...
  },
  {
    ...
    description: 'Merkle root verified for batch #8847 — 1000 events, chain intact',
  ...
  },
  {
    ...
    description: 'Support agent encountered unsupported request type — manual intervention needed',
            ...
            <div className="divide-y divide-border">
              {filteredNotifications.length === 0 ? (
                ...
                filteredNotifications.map((notif) => {
                  const TypeIconComponent = typeIcon[notif.type];
                  return (
                    <div
                      key={notif.id}
