...
import type { TenantContext, BrandConfig, BrandConfigUpdate, CustomDomainConfig } from '@ordr/core';
...
const updateBrandingSchema = z.object({
  ...
  primaryColor: z.string().regex(HEX_COLOR_REGEX, 'Must be a valid hex color (e.g., #3b82f6)').optional(),
  accentColor: z.string().regex(HEX_COLOR_REGEX, 'Must be a valid hex color (e.g., #10b981)').optional(),
  bgColor: z.string().regex(HEX_COLOR_REGEX, 'Must be a valid hex color (e.g., #0f172a)').optional(),
  textColor: z.string().regex(HEX_COLOR_REGEX, 'Must be a valid hex color (e.g., #e2e8f0)').optional(),
...
interface BrandingDependencies {
  ...
  readonly upsertBrandConfig: (tenantId: string, data: BrandConfigUpdate) => Promise<BrandConfigRecord>;
